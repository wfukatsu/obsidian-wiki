          ...
          if (fetch3.isRedirect(res.statusCode)) {
            ...
            switch (request.redirect) {
              ...
              case "follow":
                ...
                resolve(fetch3(new Request5(locationURL, requestOpts)));
                finalize();
                return;
            }
          }
...
var DEFAULT_SETTINGS = {
  ...
  // Qwen 3 系の Thinking モードはデフォルト OFF (実用速度確保)
  ollamaNumCtx: 8192,
  // 4096 では Ingest プロンプトが溢れる
  ollamaNumPredict: 0,
  // 0 = 無制限 (Ingest で長い応答が必要な場合あり)
  wikiDir: "wiki",
  sourcesDir: "sources",
  indexFile: "index.md",
  logFile: "log.md",
...
var LLMWikiSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Provider").setDesc(
      "\u516C\u958B\u30C7\u30FC\u30BF\u306A\u3089 Anthropic \u3082\u53EF\u3002\u5B9F\u30C7\u30FC\u30BF\u30FB\u6A5F\u5BC6\u30ED\u30B8\u30C3\u30AF\u3092\u6271\u3046\u5834\u5408\u306F\u5FC5\u305A Ollama (\u30ED\u30FC\u30AB\u30EB) \u3092\u4F7F\u3046\u3053\u3068\u3002"
    ).addDropdown(
      (dropdown) => {
        var _a3;
        return dropdown.addOption("ollama", "Ollama (\u30ED\u30FC\u30AB\u30EB / \u6A5F\u5BC6\u30C7\u30FC\u30BF\u53EF)").addOption("anthropic", "Anthropic (\u30AF\u30E9\u30A6\u30C9 / \u516C\u958B\u30C7\u30FC\u30BF\u306E\u307F)").setValue((_a3 = this.plugin.settings.provider) != null ? _a3 : "ollama").onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Ollama base URL").setDesc("OpenAI \u4E92\u63DB\u30A8\u30F3\u30C9\u30DD\u30A4\u30F3\u30C8\u3002\u901A\u5E38\u306F\u305D\u306E\u307E\u307E\u3067 OK\u3002").addText(
      (text) => {
        var _a3;
        return text.setPlaceholder("http://localhost:11434/v1").setValue((_a3 = this.plugin.settings.ollamaBaseUrl) != null ? _a3 : "").onChange(async (value) => {
          this.plugin.settings.ollamaBaseUrl = value;
          await this.plugin.saveSettings();
        });
      }
    );
    new import_obsidian.Setting(containerEl).setName("Ollama model").setDesc("\u4F7F\u7528\u3059\u308B\u30E2\u30C7\u30EB\u540D (\u4F8B: qwen3.5:4b)").addText(
      (text) => {
        var _a3;
        return text.setPlaceholder("qwen3.5:4b").setValue((_a3 = this.plugin.settings.ollamaModel) != null ? _a3 : "").onChange(async (value) => {
          this.plugin.settings.ollamaModel = value;
          await this.plugin.saveSettings();
        });
      }
    );
    new import_obsidian.Setting(containerEl).setName("Disable Thinking \u30E2\u30FC\u30C9").setDesc(
      "Qwen 3 \u7CFB\u306E <think> \u30BF\u30B0\u601D\u8003\u30D7\u30ED\u30BB\u30B9\u3092\u6291\u5236 (system \u5148\u982D\u306B /no_think \u3092\u81EA\u52D5\u4ED8\u4E0E)\u3002\u5B9F\u7528\u901F\u5EA6\u306B\u5FC5\u9808\u3002"
    ).addToggle(
      (toggle) => {
        var _a3;
        return toggle.setValue((_a3 = this.plugin.settings.disableThinking) != null ? _a3 : true).onChange(async (value) => {
          this.plugin.settings.disableThinking = value;
          await this.plugin.saveSettings();
        });
      }
    );
    new import_obsidian.Setting(containerEl).setName("Ollama context size (num_ctx)").setDesc(
      "\u30B3\u30F3\u30C6\u30AD\u30B9\u30C8\u7A93\u30C8\u30FC\u30AF\u30F3\u6570\u3002Ollama \u65E2\u5B9A 4096 \u3067\u306F Ingest \u30D7\u30ED\u30F3\u30D7\u30C8\u304C\u6EA2\u308C\u308B\u5834\u5408\u3042\u308A\u30028192 \u63A8\u5968\u3002"
    ).addText(
      (text) => {
        var _a3;
        return text.setPlaceholder("8192").setValue(String((_a3 = this.plugin.settings.ollamaNumCtx) != null ? _a3 : 8192)).onChange(async (value) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Ollama \u751F\u6210\u30C8\u30FC\u30AF\u30F3\u4E0A\u9650 (num_predict)").setDesc(
      "0 \u3067\u7121\u5236\u9650\u3002\u66B4\u8D70\u9632\u6B62\u306B\u6B63\u306E\u5024\u3092\u8A2D\u5B9A\u53EF\u3002Ingest \u3067\u306F\u9577\u3044\u5FDC\u7B54\u304C\u5FC5\u8981\u306A\u305F\u3081\u901A\u5E38 0\u3002"
    ).addText(
      (text) => {
        var _a3;
        return text.setPlaceholder("0").setValue(String((_a3 = this.plugin.settings.ollamaNumPredict) != null ? _a3 : 0)).onChange(async (value) => {
          const num = parseInt(value, 10);
          if (!isNaN(num) && num >= 0) {
    ...
    new import_obsidian.Setting(containerEl).setName("Anthropic model").setDesc("\u4F7F\u7528\u3059\u308B Claude \u30E2\u30C7\u30EB").addDropdown(
      (dropdown) => {
        var _a3, _b;
        return dropdown.addOption("claude-sonnet-4-20250514", "Claude Sonnet 4").addOption("claude-opus-4-20250514", "Claude Opus 4").addOption("claude-haiku-4-5-20251001", "Claude Haiku 4.5").setValue(
          (_b = (_a3 = this.plugin.settings.anthropicModel) != null ? _a3 : this.plugin.settings.model) != null ? _b : "claude-sonnet-4-20250514"
    ...
    new import_obsidian.Setting(containerEl).setName("Wiki directory").setDesc("LLM \u304C\u751F\u6210\u3059\u308B wiki \u30DA\u30FC\u30B8\u306E\u683C\u7D0D\u5148").addText(
      (text) => text.setPlaceholder("wiki").setValue(this.plugin.settings.wikiDir).onChange(async (value) => {
        this.plugin.settings.wikiDir = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("Sources directory").setDesc("\u751F\u306E\u30BD\u30FC\u30B9\u30C9\u30AD\u30E5\u30E1\u30F3\u30C8\u306E\u683C\u7D0D\u5148").addText(
      (text) => text.setPlaceholder("sources").setValue(this.plugin.settings.sourcesDir).onChange(async (value) => {
        this.plugin.settings.sourcesDir = value;
        await this.plugin.saveSettings();
      })
    );
    containerEl.createEl("h3", { text: "\u51FA\u529B" });
    new import_obsidian.Setting(containerEl).setName("Max tokens").setDesc("LLM \u30EC\u30B9\u30DD\u30F3\u30B9\u306E\u6700\u5927\u30C8\u30FC\u30AF\u30F3\u6570").addText(
      ...
      try {
        for await (const sse of _iterSSEMessages2(response, controller)) {
          ...
          if (sse.event === null || sse.event.startsWith("response.") || sse.event.startsWith("transcript.")) {
            ...
            if (data && data.error) {
              throw new APIError2(void 0, data.error, void 0, createResponseHeaders2(response.headers));
            }
            yield data;
          } else {
            let data;
...
_AssistantStream_addEvent = function _AssistantStream_addEvent2(event) {
  ...
  switch (event.event) {
    ...
    case "thread.message.completed":
    case "thread.message.incomplete":
      if (__classPrivateFieldGet13(this, _AssistantStream_currentContentIndex, "f") !== void 0) {
      ...
      __classPrivateFieldSet12(this, _AssistantStream_messageSnapshot, void 0, "f");
  }
  ...
  switch (event.event) {
    ...
    case "thread.run.step.cancelled":
    case "thread.run.step.expired":
      __classPrivateFieldSet12(this, _AssistantStream_currentRunStepSnapshot, void 0, "f");
      const details = event.data.step_details;
      if (details.type == "tool_calls") {
        if (__classPrivateFieldGet13(this, _AssistantStream_currentToolCall, "f")) {
          this._emit("toolCallDone", __classPrivateFieldGet13(this, _AssistantStream_currentToolCall, "f"));
          __classPrivateFieldSet12(this, _AssistantStream_currentToolCall, void 0, "f");
        }
      }
...
var AbstractChatCompletionRunner = class extends EventStream {
  ...
  async finalContent() {
    await this.done();
    return __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalContent).call(this);
  }
  /**
  ...
  async finalMessage() {
    await this.done();
    return __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalMessage).call(this);
  }
  /**
  ...
  async finalFunctionCall() {
    await this.done();
    return __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalFunctionCall).call(this);
  }
  async finalFunctionCallResult() {
    await this.done();
    return __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalFunctionCallResult).call(this);
  }
  async totalUsage() {
    await this.done();
    return __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_calculateTotalUsage).call(this);
  }
  allChatCompletions() {
  ...
  _emitFinal() {
    ...
    const finalMessage = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalMessage).call(this);
    if (finalMessage)
      this._emit("finalMessage", finalMessage);
    const finalContent = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalContent).call(this);
    if (finalContent)
      this._emit("finalContent", finalContent);
    const finalFunctionCall = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalFunctionCall).call(this);
    if (finalFunctionCall)
      this._emit("finalFunctionCall", finalFunctionCall);
    const finalFunctionCallResult = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalFunctionCallResult).call(this);
    if (finalFunctionCallResult != null)
      this._emit("finalFunctionCallResult", finalFunctionCallResult);
    if (this._chatCompletions.some((c2) => c2.usage)) {
      this._emit("totalUsage", __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_calculateTotalUsage).call(this));
    }
  }
  async _createChatCompletion(client, params, options) {
    ...
    __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_validateParams).call(this, params);
  ...
  async _runFunctions(client, params, options) {
    ...
    for (let i2 = 0; i2 < maxChatCompletions; ++i2) {
      ...
      const content = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_stringifyFunctionCallResult).call(this, rawContent);
...
_AbstractChatCompletionRunner_instances = /* @__PURE__ */ new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = function _AbstractChatCompletionRunner_getFinalContent2() {
  var _a3;
  return (_a3 = __classPrivateFieldGet14(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_getFinalMessage).call(this).content) != null ? _a3 : null;
...
var ChatCompletionStream = class _ChatCompletionStream extends AbstractChatCompletionRunner {
  constructor(params) {
    ...
    __classPrivateFieldSet13(this, _ChatCompletionStream_params, params, "f");
    __classPrivateFieldSet13(this, _ChatCompletionStream_choiceEventStates, [], "f");
  }
  get currentChatCompletionSnapshot() {
    return __classPrivateFieldGet15(this, _ChatCompletionStream_currentChatCompletionSnapshot, "f");
  }
  /**
   * Intended for use on the frontend, consuming a stream produced with
   * `.toReadableStream()` on the backend.
  ...
  async _createChatCompletion(client, params, options) {
    ...
    __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_beginRequest).call(this);
    const stream = await client.chat.completions.create({ ...params, stream: true }, { ...options, signal: this.controller.signal });
    this._connected();
    for await (const chunk of stream) {
      __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_addChunk).call(this, chunk);
    }
    if ((_a3 = stream.controller.signal) == null ? void 0 : _a3.aborted) {
      throw new APIUserAbortError2();
    }
    return this._addChatCompletion(__classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_endRequest).call(this));
  }
  async _fromReadableStream(readableStream, options) {
    var _a3;
    const signal = options == null ? void 0 : options.signal;
    ...
    for await (const chunk of stream) {
      if (chatId && chatId !== chunk.id) {
        this._addChatCompletion(__classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_endRequest).call(this));
      }
      __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_addChunk).call(this, chunk);
      chatId = chunk.id;
    }
  ...
  [(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest2() {
    if (this.ended)
      return;
    __classPrivateFieldSet13(this, _ChatCompletionStream_currentChatCompletionSnapshot, void 0, "f");
  }, _ChatCompletionStream_getChoiceEventState = function _ChatCompletionStream_getChoiceEventState2(choice) {
    let state = __classPrivateFieldGet15(this, _ChatCompletionStream_choiceEventStates, "f")[choice.index];
    if (state) {
      return state;
    }
    state = {
    ...
    __classPrivateFieldGet15(this, _ChatCompletionStream_choiceEventStates, "f")[choice.index] = state;
    return state;
  }, _ChatCompletionStream_addChunk = function _ChatCompletionStream_addChunk2(chunk) {
    var _a3, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r2, _s, _t2;
    if (this.ended)
      return;
    const completion = __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_accumulateChatCompletion).call(this, chunk);
    ...
    for (const choice of chunk.choices) {
      ...
      if (choiceSnapshot.finish_reason) {
        __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_emitContentDoneEvents).call(this, choiceSnapshot);
        if (state.current_tool_call_index != null) {
          __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_emitToolCallDoneEvent).call(this, choiceSnapshot, state.current_tool_call_index);
        }
      }
    ...
    if (toolCallSnapshot.type === "function") {
      const inputTool = (_c = (_b = __classPrivateFieldGet15(this, _ChatCompletionStream_params, "f")) == null ? void 0 : _b.tools) == null ? void 0 : _c.find((tool) => tool.type === "function" && tool.function.name === toolCallSnapshot.function.name);
    ...
    if (choiceSnapshot.message.content && !state.content_done) {
      ...
      const responseFormat = __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getAutoParseableResponseFormat).call(this);
    ...
    const snapshot = __classPrivateFieldGet15(this, _ChatCompletionStream_currentChatCompletionSnapshot, "f");
    if (!snapshot) {
      throw new OpenAIError(`request ended without sending any chunks`);
    }
    __classPrivateFieldSet13(this, _ChatCompletionStream_currentChatCompletionSnapshot, void 0, "f");
    __classPrivateFieldSet13(this, _ChatCompletionStream_choiceEventStates, [], "f");
    return finalizeChatCompletion(snapshot, __classPrivateFieldGet15(this, _ChatCompletionStream_params, "f"));
  }, _ChatCompletionStream_getAutoParseableResponseFormat = function _ChatCompletionStream_getAutoParseableResponseFormat2() {
    var _a3;
    const responseFormat = (_a3 = __classPrivateFieldGet15(this, _ChatCompletionStream_params, "f")) == null ? void 0 : _a3.response_format;
    ...
    var _a3, _b, _c, _d;
    let snapshot = __classPrivateFieldGet15(this, _ChatCompletionStream_currentChatCompletionSnapshot, "f");
    const { choices, ...rest } = chunk;
    if (!snapshot) {
      snapshot = __classPrivateFieldSet13(this, _ChatCompletionStream_currentChatCompletionSnapshot, {
        ...rest,
        choices: []
      }, "f");
    } else {
    ...
    for (const { delta, finish_reason, index, logprobs = null, ...other } of chunk.choices) {
      ...
      if (finish_reason) {
        ...
        if (__classPrivateFieldGet15(this, _ChatCompletionStream_params, "f") && hasAutoParseableInput(__classPrivateFieldGet15(this, _ChatCompletionStream_params, "f"))) {
      ...
      if (content) {
        ...
        if (!choice.message.refusal && __classPrivateFieldGet15(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getAutoParseableResponseFormat).call(this)) {
      ...
      if (tool_calls) {
        ...
        for (const { index: index2, id, type, function: fn, ...rest3 } of tool_calls) {
          ...
          if (fn == null ? void 0 : fn.arguments) {
            ...
            if (shouldParseToolCall(__classPrivateFieldGet15(this, _ChatCompletionStream_params, "f"), tool_call)) {
...
var ResponseStream = class _ResponseStream extends EventStream {
  ...
  async _createOrRetrieveResponse(client, params, options) {
    ...
    this._connected();
    for await (const event of stream) {
      __classPrivateFieldGet16(this, _ResponseStream_instances, "m", _ResponseStream_addEvent).call(this, event, starting_after);
    }
  ...
  [(_ResponseStream_params = /* @__PURE__ */ new WeakMap(), _ResponseStream_currentResponseSnapshot = /* @__PURE__ */ new WeakMap(), _ResponseStream_finalResponse = /* @__PURE__ */ new WeakMap(), _ResponseStream_instances = /* @__PURE__ */ new WeakSet(), _ResponseStream_beginRequest = function _ResponseStream_beginRequest2() {
    if (this.ended)
      return;
    __classPrivateFieldSet14(this, _ResponseStream_currentResponseSnapshot, void 0, "f");
...
var LLMClient = class {
  ...
  async callAnthropic(system, user) {
    ...
    const modelName = (_a3 = this.settings.model) != null ? _a3 : this.settings.anthropicModel;
...
${system}` : system;
    ...
    if (this.settings.ollamaNumPredict !== void 0 && this.settings.ollamaNumPredict > 0) {
    ...
    const raw = ((_b = (_a3 = completion.choices[0]) == null ? void 0 : _a3.message) == null ? void 0 : _b.content) || "";
...
// src/ingest.ts
var INGEST_SYSTEM = `You are a wiki maintainer. You receive a source document and the current state of a personal wiki.
...
async function ingestSource(app, settings, sourceFile) {
  const llm = new LLMClient(settings);
  const sourceContent = await app.vault.read(sourceFile);
  const wikiFiles = app.vault.getFiles().filter(
    (f2) => f2.path.startsWith(settings.wikiDir + "/")
  );
  const wikiIndex = [];
  for (const f2 of wikiFiles) {
    const content = await app.vault.read(f2);
    const firstLines = content.split("\n").slice(0, 10).join("\n");
    wikiIndex.push(`--- ${f2.path} ---
${firstLines}`);
  }
  const indexPath = (0, import_obsidian2.normalizePath)(settings.indexFile);
  const schemaPath = (0, import_obsidian2.normalizePath)(settings.schemaFile);
  let existingIndex = "";
  let schema = "";
  try {
    const indexFile = app.vault.getAbstractFileByPath(indexPath);
    if (indexFile instanceof import_obsidian2.TFile)
      existingIndex = await app.vault.read(indexFile);
  } catch (e2) {
  }
  try {
    const schemaFile = app.vault.getAbstractFileByPath(schemaPath);
    if (schemaFile instanceof import_obsidian2.TFile)
      schema = await app.vault.read(schemaFile);
  } catch (e2) {
  }
...
${sourceContent}`;
  new import_obsidian2.Notice("LLM Wiki: Ingesting source...");
  ...
  try {
    ...
    if (!parsed) {
      throw new Error(
        "LLM returned invalid JSON even after extraction fallback. Response head:\n" + response.slice(0, 500)
      );
    }
  }
  const result = {
  ...
  if (parsed.indexEntry) {
    ...
    if (idxFile instanceof import_obsidian2.TFile) {
      const current = await app.vault.read(idxFile);
      await app.vault.modify(idxFile, current.trimEnd() + "\n" + parsed.indexEntry + "\n");
    }
  }
  if (parsed.logEntry) {
    const logPath = (0, import_obsidian2.normalizePath)(settings.logFile);
...
`;
  ...
  new import_obsidian2.Notice(`LLM Wiki: Ingested! ${result.pagesCreated.length} created, ${result.pagesUpdated.length} updated`);
  return result;
}
...
var QUERY_SYSTEM = `You are a wiki assistant. You answer questions by searching through the personal wiki pages provided.
...
async function queryWiki(app, settings, question) {
  const llm = new LLMClient(settings);
  const wikiFiles = app.vault.getFiles().filter(
    (f2) => f2.path.startsWith(settings.wikiDir + "/")
  );
...
${content}`);
  ...
  const schemaPath = (0, import_obsidian3.normalizePath)(settings.schemaFile);
  let schema = "";
  try {
    const schemaFile = app.vault.getAbstractFileByPath(schemaPath);
...
async function saveQueryAsPage(app, settings, question, result) {
  const filename = result.suggestedFilename || "query-result.md";
  const pagePath = (0, import_obsidian3.normalizePath)(`${settings.wikiDir}/${filename}`);
  const today = (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
  const content = `---
title: "${question}"
type: synthesis
date: ${today}
sources: [${result.citations.map((c2) => `"${c2}"`).join(", ")}]
---
...
`;
  ...
  const indexPath = (0, import_obsidian3.normalizePath)(settings.indexFile);
  const indexFile = app.vault.getAbstractFileByPath(indexPath);
  if (indexFile instanceof import_obsidian3.TFile) {
...
`
  ...
  const logPath = (0, import_obsidian3.normalizePath)(settings.logFile);
  const logFile = app.vault.getAbstractFileByPath(logPath);
...
var LINT_SYSTEM = `You are a wiki quality auditor. Review the wiki pages for issues.
...
async function lintWiki(app, settings) {
  var _a3;
  const llm = new LLMClient(settings);
  const wikiFiles = app.vault.getFiles().filter(
    (f2) => f2.path.startsWith(settings.wikiDir + "/")
...
${content}`);
  ...
  const indexPath = (0, import_obsidian4.normalizePath)(settings.indexFile);
  let indexContent = "";
  try {
    const indexFile = app.vault.getAbstractFileByPath(indexPath);
    if (indexFile instanceof import_obsidian4.TFile)
...
Please audit this wiki for issues.`;
  ...
  return {
    ...
    healthScore: (_a3 = parsed.healthScore) != null ? _a3 : 0,
    summary: parsed.summary || ""
  };
}
...
var LLMWikiPlugin = class extends import_obsidian5.Plugin {
  ...
  async ensureApiKey() {
    if (!this.settings.apiKey) {
      new import_obsidian5.Notice("LLM Wiki: Please set your Anthropic API key in settings.");
      return false;
    }
    return true;
  }
  async runIngest(file) {
    if (!await this.ensureApiKey())
      return;
    try {
      const result = await ingestSource(this.app, this.settings, file);
      new import_obsidian5.Notice(`Ingest complete: ${result.summary}`);
    } catch (e2) {
      new import_obsidian5.Notice(`Ingest failed: ${e2.message}`);
      console.error("LLM Wiki ingest error:", e2);
    }
  }
  async runLint() {
    if (!await this.ensureApiKey())
      return;
    new import_obsidian5.Notice("LLM Wiki: Running lint...");
    try {
      const result = await lintWiki(this.app, this.settings);
      new LintResultModal(this.app, result).open();
    } catch (e2) {
      new import_obsidian5.Notice(`Lint failed: ${e2.message}`);
      console.error("LLM Wiki lint error:", e2);
    }
  }
  async initVault() {
    const dirs = [this.settings.wikiDir, this.settings.sourcesDir];
    for (const dir of dirs) {
      const path = (0, import_obsidian5.normalizePath)(dir);
    ...
    for (const [name, content] of Object.entries(files)) {
      const path = (0, import_obsidian5.normalizePath)(name);
      if (!this.app.vault.getAbstractFileByPath(path)) {
        await this.app.vault.create(path, content);
      }
    }
    new import_obsidian5.Notice("LLM Wiki: Vault structure initialized!");
  }
  async loadSettings() {
...
var QueryModal = class extends import_obsidian5.Modal {
  constructor(app, plugin) {
    super(app);
  ...
  onOpen() {
    ...
    askBtn.addEventListener("click", async () => {
      ...
      if (!this.plugin.settings.apiKey) {
        new import_obsidian5.Notice("Set your API key in LLM Wiki settings first.");
        return;
      }
      ...
      try {
        ...
        new import_obsidian5.Notice(`Query failed: ${e2.message}`);
      } finally {
  ...
  showResult(result) {
    ...
    if (result.shouldSave) {
      ...
      saveBtn.addEventListener("click", async () => {
        ...
        new import_obsidian5.Notice(`Saved to ${path}`);
...
var SourceSelectModal = class extends import_obsidian5.Modal {
  ...
  onOpen() {
    ...
    const files = this.app.vault.getFiles().filter((f2) => f2.path.startsWith(sourcesDir + "/"));
    if (files.length === 0) {
...
var LintResultModal = class extends import_obsidian5.Modal {
